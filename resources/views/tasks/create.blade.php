                ...
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('title') }}" placeholder="Enter Task Title" maxlength="100" id="title"
                            name="title">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local"
                            class="form-control form-control-sm rounded-cs @error('due_date') is-invalid @enderror datetime"
                            value="{{ old('due_date') }}" placeholder="Select Due Date"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" cols="30" rows="5"
                            class="form-control form-control-sm rounded-cs @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                    </div>
