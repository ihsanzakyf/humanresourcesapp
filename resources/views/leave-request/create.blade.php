                ...
                <form action="{{ route('leave-requests.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="leave_type" id="leave_type"
                            ...
                            <option value="" disabled {{ old('leave_type') ? '' : 'selected' }}>--Select Leave Type--
                            </option>
                            <option value="sick" {{ old('leave_type') == 'sick' ? 'selected' : '' }}>Sick</option>
                            <option value="vacation" {{ old('leave_type') == 'vacation' ? 'selected' : '' }}>Vacation
                            </option>
                            <option value="maternity" {{ old('leave_type') == 'maternity' ? 'selected' : '' }}>Maternity
                            </option>
                        </select>
                        @error('leave_type')
                            <div class="invalid-feedback">{{ $message }}</div>
