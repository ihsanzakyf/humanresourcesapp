                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <a href="{{ route('departments.create') }}" class="btn btn-sm btn-primary rounded-cs">
                            ...
                            @foreach ($departments as $department)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-secondary rounded-cs">Inactive</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group mb-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuButton"
                                                    ...
                                                    <form id="form-delete-{{ $department->id }}" method="POST"
                                                        class="d-inline"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-swal-form-id="form-delete-{{ $department->id }}"
                                                            style="background-color:#dc3545;">
                                                            <i class="bi bi-trash me-1"></i> Delete
                                                        </button>
                                                    </form>

                                                    <x-sweetalertaction form-id="form-delete-{{ $department->id }}"
                                                        action="delete" />
