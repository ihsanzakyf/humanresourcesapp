                ...
                <form action="{{ route('departments.update', $department->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('name', $department->name) }}" placeholder="Enter Task name" maxlength="100"
                            id="name" name="name">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="description"
                            ...
                            value="{{ old('description', $department->description) }}" placeholder="Enter description"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="inactive"
                                {{ old('status', $department->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
