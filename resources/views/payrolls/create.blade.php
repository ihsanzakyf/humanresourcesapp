                ...
                <form action="{{ route('payrolls.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="deductions" id="deductions"
                            ...
                            value="{{ old('deductions') }}" placeholder="Deductions">
                        @error('deductions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="bonuses" id="bonuses"
                            ...
                            value="{{ old('bonuses') }}" placeholder="Bonuses">
                        @error('bonuses')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 d-none">
                        ...
                        <input type="number" name="net_salary" id="net_salary"
                            ...
                            value="{{ old('net_salary') }}" placeholder="Net Salary" disabled>
                        @error('net_salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pay_date" id="pay_date"
                            ...
                            value="{{ old('pay_date') }}" placeholder="Pay Date">
                        @error('pay_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
